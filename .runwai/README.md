...
| [`docs/provenance.md`](docs/provenance.md) | Upstream repo, commit SHA and licence for every derived file |
| [`docs/pinning.md`](docs/pinning.md) | Verified tool pins, pending pins, how to complete one |
| [`contributing.md`](contributing.md) | How to contribute **to runwAI** — adding a check, provenance requirements |
| [`docs/status.md`](docs/status.md) | What is present, and what is honestly known about its limits |
| [`docs/report.md`](docs/report.md) | The self-check readout. Generated by `tools/report.py`; never edit by hand |
| [`social-preview/`](social-preview/README.md) | The 1280×640 card GitHub unfurls for *this* repository, its HTML source and its pinned renderer. runwAI's own branding, so it is not the adopter's |
